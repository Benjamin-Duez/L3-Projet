...
public class Pretre extends PJ {
	...
	public void levelUp()
	{
		...
		switch(alea) {
		case 5:
			esp+=1;hp_max+=1;mag+=1;mp_max+=1;arm+=1;hp=hp_max;mp=mp_max;
			break;
		case 6:
			esp+=2;hp_max+=1;mag+=1;mp_max+=1;arm+=1;hp=hp_max;mp=mp_max;
			break;
		case 7:
			esp+=2;hp_max+=1;mag+=1;mp_max+=1;arm+=1;att+=1;hp=hp_max;mp=mp_max;
			break;
		case 8:
			esp+=2;hp_max+=2;mag+=1;mp_max+=1;arm+=1;att+=1;hp=hp_max;mp=mp_max;
			break;
		case 9:
			esp+=2;hp_max+=2;mag+=1;mp_max+=2;arm+=1;att+=1;hp=hp_max;mp=mp_max;
			break;
		case 10:
			esp+=3;hp_max+=2;mag+=2;mp_max+=2;arm+=1;hp=hp_max;mp=mp_max;
			break;
		}
		lvl++;
