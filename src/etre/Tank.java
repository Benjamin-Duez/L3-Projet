...
public class Tank extends PJ{
	...
	public void levelUp()
	{
		...
		switch(alea) {
		case 5:
			arm+=1;hp_max+=1;att+=1;mp_max+=1;esp+=1;hp=hp_max;mp=mp_max;
			break;
		case 6:
			arm+=2;hp_max+=1;att+=1;mp_max+=1;esp+=1;hp=hp_max;mp=mp_max;
			break;
		case 7:
			arm+=2;hp_max+=1;att+=1;mp_max+=1;esp+=1;mag+=1;hp=hp_max;mp=mp_max;
			break;
		case 8:
			arm+=2;hp_max+=2;att+=1;mp_max+=1;esp+=1;mag+=1;hp=hp_max;mp=mp_max;
			break;
		case 9:
			arm+=2;hp_max+=2;att+=1;mp_max+=1;esp+=2;mag+=1;hp=hp_max;mp=mp_max;
			break;
		case 10:
			arm+=3;hp_max+=2;att+=1;mp_max+=1;esp+=2;mag+=1;hp=hp_max;mp=mp_max;
			break;
		}
		lvl++;
